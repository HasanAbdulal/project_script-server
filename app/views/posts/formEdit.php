            ...
            <div class="col-md-12 blog-post">
                ...
                <form action="posts/<?php echo $post['id']; ?>/<?php echo Core\Functions\slugify($post['title']); ?>/edit/update.html" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="text" name="text" class="form-control" rows="5" placeholder="Enter your text here" required>
                            <?php echo $post['text']; ?>
                        </textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="image"> Image</label>
                        <input type="hidden" name="imageName" class="form-control-file btn btn-primary"
                                id="image" value="<?php echo $post['image']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="quote">Quote</label>
                        <textarea required
                            id="quote" name="quote" class="form-control"
                            rows="5" placeholder="Enter your quote here">
                            <?php echo $post['quote']; ?>
                        </textarea>
                    </div>
                    <div class="form-group">
